/*escrevemos STRINGS entre aspas. Ou seja: 'assim'*/
...
personagens.forEach(personagem => {
    personagem.addEventListener('mouseenter', () => {
        ...
        removerSelecaoDoPersonagem(); //clicar em cima da refatoração e aperta F12 leva para linha de código escrita anteriormente
